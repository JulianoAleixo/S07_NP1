...
| PT-001 | Load           | Sustains 20 concurrent users without errors or degraded response time         | Performance |
| PT-002 | stress         | Handles increasing concurrency up to 150 users, identifying degradation point | Performance |
| PT-003 | spike          | Recovers from sudden traffic burst (0 -> 200 users in 10s)                    | Performance |
